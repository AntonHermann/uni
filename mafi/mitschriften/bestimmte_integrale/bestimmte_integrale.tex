...
Gegeben $f: [a,b] \rightarrow \R$ stetig\\
Berachte Unterteilung von $[a,b]$ mit Zwischenpunkten\\
Untert: $a = x_0 < x_1 < x_2 < ... < x_n = b$\\
Zwischenpunkte: $x_{i-1} \leq \xi \leq x_i$\\

Satz und Definition:\\
Fuer jede Folge von sich verfeinernden Unterteilungen (in jeden
Schnitt wird ein Teilintervall weiter unterteilt) mit der zusätzlichen
Eigenschaft, dass die Breite des linken Teilintervalls gegen 0 geht, und
jede Folge von entsprecheden Zwischenpunkten konvergiert die Folge der
Zwischensummen gegen einen eindeutigen Wert, den an das bestimmte
Integral von f ueber $[a,b]$ nennt.\\
Notation: $\int_a^b f(x) dx = \lim_{n\to\infty} Z_n$
