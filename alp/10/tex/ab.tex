...
\lstinputlisting[language=Java, caption="HuffmanEncode.java"]{../HuffmanEncode.java}
\lstinputlisting[language=Java, caption="HuffmanTree.java"]{../HuffmanTree.java}
\lstinputlisting[language=Java, caption="BinaryIOWriter.java"]{../BinaryIOWriter.java}
