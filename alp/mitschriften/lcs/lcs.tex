...
\section*{Längste gemeinsame Teilfolge}
teilfolge: gleiche sich wiederholende zeichen, es können aber andere zeichen
dazwischen sein.\\
2 Strings s und t, s'/t' ist s/t ohne letztes Zeichen\\
LLCS = Länge der längsten gemeinsamen Teilfolge\\
Wenn s leer oder t leer $\Rightarrow$ LLCS(s,t) = 0\\
Wenn s und t selben letzten Buchstaben haben $\Rightarrow$ LLCS(s,t) = 1 + LLCS(s', t')\\
Sonst: LLCS(s,t) = max(LLCS(s', t), (LLCS(s, t')))
